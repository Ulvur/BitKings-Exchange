...
**BitKings Exchange API has been elaborated using Binance API documentation as the main source of reference (https://github.com/binance-exchange/binance-official-api-docs)*
